...
import * as dependency_2 from "./Discover";
import * as dependency_3 from "./contract/common";
...
export namespace protocol {
    ...
    export namespace Account {
        ...
        export class FreezeV2 extends pb_1.Message {
            #one_of_decls: number[][] = [];
            constructor(data?: any[] | {
                type?: dependency_3.protocol.ResourceCode;
                amount?: number;
            }) {
                super();
                pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            ...
            get type() {
                return pb_1.Message.getFieldWithDefault(this, 1, dependency_3.protocol.ResourceCode.BANDWIDTH) as dependency_3.protocol.ResourceCode;
            }
            set type(value: dependency_3.protocol.ResourceCode) {
                pb_1.Message.setField(this, 1, value);
            }
            get amount() {
                return pb_1.Message.getFieldWithDefault(this, 2, 0) as number;
            ...
            serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
                const writer = w || new pb_1.BinaryWriter();
                if (this.type != dependency_3.protocol.ResourceCode.BANDWIDTH)
    ...
    export namespace Transaction {
        export class Contract extends pb_1.Message {
            ...
            constructor(data?: any[] | {
                ...
                parameter?: dependency_1.google.protobuf.Any;
                provider?: Uint8Array;
            ...
            set parameter(value: dependency_1.google.protobuf.Any) {
                pb_1.Message.setWrapperField(this, 2, value);
            }
            get has_parameter() {
                return pb_1.Message.getField(this, 2) != null;
            ...
            static fromObject(data: {
                type?: Transaction.Contract.ContractType;
                parameter?: ReturnType<typeof dependency_1.google.protobuf.Any.prototype.toObject>;
                provider?: Uint8Array;
                ContractName?: Uint8Array;
                Permission_id?: number;
            }): Contract {
                ...
                if (data.parameter != null) {
                    message.parameter = dependency_1.google.protobuf.Any.fromObject(data.parameter);
                }
                ...
                while (reader.nextField()) {
                    ...
                    switch (reader.getFieldNumber()) {
                        case 1:
                            ...
                            break;
                        case 2:
                            reader.readMessage(message.parameter, () => message.parameter = dependency_1.google.protobuf.Any.deserialize(reader));
                            break;
                        case 3:
    ...
    export class HelloMessage extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            from?: dependency_2.protocol.Endpoint;
            version?: number;
            timestamp?: number;
        ...
        get from() {
            return pb_1.Message.getWrapperField(this, dependency_2.protocol.Endpoint, 1) as dependency_2.protocol.Endpoint;
        }
        set from(value: dependency_2.protocol.Endpoint) {
            pb_1.Message.setWrapperField(this, 1, value);
        }
        get has_from() {
            return pb_1.Message.getField(this, 1) != null;
        ...
        static fromObject(data: {
            from?: ReturnType<typeof dependency_2.protocol.Endpoint.prototype.toObject>;
            version?: number;
            timestamp?: number;
            ...
            if (data.from != null) {
                message.from = dependency_2.protocol.Endpoint.fromObject(data.from);
            }
            if (data.version != null) {
                message.version = data.version;
            }
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): HelloMessage {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.from, () => message.from = dependency_2.protocol.Endpoint.deserialize(reader));
                        break;
                    case 2:
                        message.version = reader.readInt32();
                        break;
