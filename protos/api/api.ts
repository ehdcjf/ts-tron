...
import * as dependency_1 from "./../core/Tron";
import * as dependency_2 from "./../google/api/annotations";
import * as dependency_3 from "./../core/contract/asset_issue_contract";
import * as dependency_4 from "./../core/contract/account_contract";
import * as dependency_5 from "./../core/contract/witness_contract";
import * as dependency_6 from "./../core/contract/balance_contract";
import * as dependency_7 from "./../core/contract/proposal_contract";
import * as dependency_8 from "./../core/contract/storage_contract";
import * as dependency_9 from "./../core/contract/exchange_contract";
import * as dependency_10 from "./../core/contract/market_contract";
import * as dependency_11 from "./../core/contract/smart_contract";
import * as dependency_12 from "./../core/contract/shield_contract";
...
export namespace protocol {
    ...
    export class BlockIncrementalMerkleTree extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            number?: number;
            merkleTree?: dependency_12.protocol.IncrementalMerkleTree;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get merkleTree() {
            return pb_1.Message.getWrapperField(this, dependency_12.protocol.IncrementalMerkleTree, 2) as dependency_12.protocol.IncrementalMerkleTree;
        }
        set merkleTree(value: dependency_12.protocol.IncrementalMerkleTree) {
            pb_1.Message.setWrapperField(this, 2, value);
        }
        get has_merkleTree() {
            return pb_1.Message.getField(this, 2) != null;
        ...
        static fromObject(data: {
            number?: number;
            merkleTree?: ReturnType<typeof dependency_12.protocol.IncrementalMerkleTree.prototype.toObject>;
            ...
            if (data.merkleTree != null) {
                message.merkleTree = dependency_12.protocol.IncrementalMerkleTree.fromObject(data.merkleTree);
            }
            return message;
        }
        toObject() {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        reader.readMessage(message.merkleTree, () => message.merkleTree = dependency_12.protocol.IncrementalMerkleTree.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class SpendNote extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            note?: Note;
            alpha?: Uint8Array;
            voucher?: dependency_12.protocol.IncrementalMerkleVoucher;
            path?: Uint8Array;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
        ...
        get voucher() {
            return pb_1.Message.getWrapperField(this, dependency_12.protocol.IncrementalMerkleVoucher, 5) as dependency_12.protocol.IncrementalMerkleVoucher;
        }
        set voucher(value: dependency_12.protocol.IncrementalMerkleVoucher) {
            pb_1.Message.setWrapperField(this, 5, value);
        }
        get has_voucher() {
            return pb_1.Message.getField(this, 5) != null;
        ...
        static fromObject(data: {
            note?: ReturnType<typeof Note.prototype.toObject>;
            alpha?: Uint8Array;
            voucher?: ReturnType<typeof dependency_12.protocol.IncrementalMerkleVoucher.prototype.toObject>;
            path?: Uint8Array;
        }): SpendNote {
            ...
            if (data.voucher != null) {
                message.voucher = dependency_12.protocol.IncrementalMerkleVoucher.fromObject(data.voucher);
            }
            if (data.path != null) {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        reader.readMessage(message.voucher, () => message.voucher = dependency_12.protocol.IncrementalMerkleVoucher.deserialize(reader));
                        break;
                    case 6:
    ...
    export class NfParameters extends pb_1.Message {
        ...
        get voucher() {
            return pb_1.Message.getWrapperField(this, dependency_12.protocol.IncrementalMerkleVoucher, 2) as dependency_12.protocol.IncrementalMerkleVoucher;
        }
        set voucher(value: dependency_12.protocol.IncrementalMerkleVoucher) {
            pb_1.Message.setWrapperField(this, 2, value);
        }
    ...
    export class ShieldedTRC20Parameters extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            spend_description?: dependency_12.protocol.SpendDescription[];
            receive_description?: dependency_12.protocol.ReceiveDescription[];
        ...
        get spend_description() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_12.protocol.SpendDescription, 1) as dependency_12.protocol.SpendDescription[];
        }
        set spend_description(value: dependency_12.protocol.SpendDescription[]) {
            pb_1.Message.setRepeatedWrapperField(this, 1, value);
        }
        get receive_description() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_12.protocol.ReceiveDescription, 2) as dependency_12.protocol.ReceiveDescription[];
        }
        set receive_description(value: dependency_12.protocol.ReceiveDescription[]) {
        ...
        static fromObject(data: {
            spend_description?: ReturnType<typeof dependency_12.protocol.SpendDescription.prototype.toObject>[];
            receive_description?: ReturnType<typeof dependency_12.protocol.ReceiveDescription.prototype.toObject>[];
            binding_signature?: Uint8Array;
            message_hash?: Uint8Array;
            trigger_contract_input?: string;
            parameter_type?: string;
            ...
            if (data.spend_description != null) {
                message.spend_description = data.spend_description.map(item => dependency_12.protocol.SpendDescription.fromObject(item));
            }
            if (data.receive_description != null) {
                message.receive_description = data.receive_description.map(item => dependency_12.protocol.ReceiveDescription.fromObject(item));
            }
        ...
        toObject() {
            ...
            if (this.spend_description != null) {
                data.spend_description = this.spend_description.map((item: dependency_12.protocol.SpendDescription) => item.toObject());
            }
            if (this.receive_description != null) {
                data.receive_description = this.receive_description.map((item: dependency_12.protocol.ReceiveDescription) => item.toObject());
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.spend_description.length)
                writer.writeRepeatedMessage(1, this.spend_description, (item: dependency_12.protocol.SpendDescription) => item.serialize(writer));
            if (this.receive_description.length)
                writer.writeRepeatedMessage(2, this.receive_description, (item: dependency_12.protocol.ReceiveDescription) => item.serialize(writer));
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ShieldedTRC20Parameters {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.spend_description, () => pb_1.Message.addToRepeatedWrapperField(message, 1, dependency_12.protocol.SpendDescription.deserialize(reader), dependency_12.protocol.SpendDescription));
                        break;
                    case 2:
                        reader.readMessage(message.receive_description, () => pb_1.Message.addToRepeatedWrapperField(message, 2, dependency_12.protocol.ReceiveDescription.deserialize(reader), dependency_12.protocol.ReceiveDescription));
                        break;
                    case 3:
    ...
    export abstract class UnimplementedWalletService {
        static definition = {
            ...
            GetAccountBalance: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_6.protocol.AccountBalanceRequest) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_6.protocol.AccountBalanceRequest.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: dependency_6.protocol.AccountBalanceResponse) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => dependency_6.protocol.AccountBalanceResponse.deserialize(new Uint8Array(bytes))
            },
            GetBlockBalanceTrace: {
                path: "/protocol.Wallet/GetBlockBalanceTrace",
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_6.protocol.BlockBalanceTrace.BlockIdentifier) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_6.protocol.BlockBalanceTrace.BlockIdentifier.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: dependency_6.protocol.BlockBalanceTrace) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => dependency_6.protocol.BlockBalanceTrace.deserialize(new Uint8Array(bytes))
            },
            CreateTransaction: {
                path: "/protocol.Wallet/CreateTransaction",
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_6.protocol.TransferContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_6.protocol.TransferContract.deserialize(new Uint8Array(bytes)),
            ...
            UpdateAccount: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_4.protocol.AccountUpdateContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_4.protocol.AccountUpdateContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: dependency_1.protocol.Transaction) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => dependency_1.protocol.Transaction.deserialize(new Uint8Array(bytes))
            },
            SetAccountId: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_4.protocol.SetAccountIdContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_4.protocol.SetAccountIdContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: dependency_1.protocol.Transaction) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => dependency_1.protocol.Transaction.deserialize(new Uint8Array(bytes))
            },
            UpdateAccount2: {
            ...
            VoteWitnessAccount: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_5.protocol.VoteWitnessContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_5.protocol.VoteWitnessContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: dependency_1.protocol.Transaction) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => dependency_1.protocol.Transaction.deserialize(new Uint8Array(bytes))
            },
            UpdateSetting: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_11.protocol.UpdateSettingContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_11.protocol.UpdateSettingContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: TransactionExtention) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => TransactionExtention.deserialize(new Uint8Array(bytes))
            },
            UpdateEnergyLimit: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_11.protocol.UpdateEnergyLimitContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_11.protocol.UpdateEnergyLimitContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: TransactionExtention) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => TransactionExtention.deserialize(new Uint8Array(bytes))
            },
            VoteWitnessAccount2: {
            ...
            UpdateWitness: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_5.protocol.WitnessUpdateContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_5.protocol.WitnessUpdateContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: dependency_1.protocol.Transaction) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => dependency_1.protocol.Transaction.deserialize(new Uint8Array(bytes))
            },
            UpdateWitness2: {
            ...
            CreateAccount: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_4.protocol.AccountCreateContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_4.protocol.AccountCreateContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: dependency_1.protocol.Transaction) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => dependency_1.protocol.Transaction.deserialize(new Uint8Array(bytes))
            },
            CreateAccount2: {
            ...
            CreateWitness: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_5.protocol.WitnessCreateContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_5.protocol.WitnessCreateContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: dependency_1.protocol.Transaction) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => dependency_1.protocol.Transaction.deserialize(new Uint8Array(bytes))
            },
            CreateWitness2: {
            ...
            FreezeBalance: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_6.protocol.FreezeBalanceContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_6.protocol.FreezeBalanceContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: dependency_1.protocol.Transaction) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => dependency_1.protocol.Transaction.deserialize(new Uint8Array(bytes))
            },
            FreezeBalance2: {
            ...
            FreezeBalanceV2: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_6.protocol.FreezeBalanceV2Contract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_6.protocol.FreezeBalanceV2Contract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: TransactionExtention) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => TransactionExtention.deserialize(new Uint8Array(bytes))
            },
            UnfreezeBalance: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_6.protocol.UnfreezeBalanceContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_6.protocol.UnfreezeBalanceContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: dependency_1.protocol.Transaction) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => dependency_1.protocol.Transaction.deserialize(new Uint8Array(bytes))
            },
            UnfreezeBalance2: {
            ...
            UnfreezeBalanceV2: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_6.protocol.UnfreezeBalanceV2Contract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_6.protocol.UnfreezeBalanceV2Contract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: TransactionExtention) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => TransactionExtention.deserialize(new Uint8Array(bytes))
            },
            UnfreezeAsset: {
            ...
            WithdrawBalance: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_6.protocol.WithdrawBalanceContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_6.protocol.WithdrawBalanceContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: dependency_1.protocol.Transaction) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => dependency_1.protocol.Transaction.deserialize(new Uint8Array(bytes))
            },
            WithdrawBalance2: {
            ...
            WithdrawExpireUnfreeze: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_6.protocol.WithdrawExpireUnfreezeContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_6.protocol.WithdrawExpireUnfreezeContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: TransactionExtention) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => TransactionExtention.deserialize(new Uint8Array(bytes))
            },
            DelegateResource: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_6.protocol.DelegateResourceContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_6.protocol.DelegateResourceContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: TransactionExtention) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => TransactionExtention.deserialize(new Uint8Array(bytes))
            },
            UnDelegateResource: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_6.protocol.UnDelegateResourceContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_6.protocol.UnDelegateResourceContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: TransactionExtention) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => TransactionExtention.deserialize(new Uint8Array(bytes))
            },
            CancelAllUnfreezeV2: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_6.protocol.CancelAllUnfreezeV2Contract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_6.protocol.CancelAllUnfreezeV2Contract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: TransactionExtention) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => TransactionExtention.deserialize(new Uint8Array(bytes))
            },
            UpdateAsset: {
            ...
            ProposalCreate: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_7.protocol.ProposalCreateContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_7.protocol.ProposalCreateContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: TransactionExtention) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => TransactionExtention.deserialize(new Uint8Array(bytes))
            },
            ProposalApprove: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_7.protocol.ProposalApproveContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_7.protocol.ProposalApproveContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: TransactionExtention) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => TransactionExtention.deserialize(new Uint8Array(bytes))
            },
            ProposalDelete: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_7.protocol.ProposalDeleteContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_7.protocol.ProposalDeleteContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: TransactionExtention) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => TransactionExtention.deserialize(new Uint8Array(bytes))
            },
            BuyStorage: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_8.protocol.BuyStorageContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_8.protocol.BuyStorageContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: TransactionExtention) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => TransactionExtention.deserialize(new Uint8Array(bytes))
            },
            BuyStorageBytes: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_8.protocol.BuyStorageBytesContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_8.protocol.BuyStorageBytesContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: TransactionExtention) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => TransactionExtention.deserialize(new Uint8Array(bytes))
            },
            SellStorage: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_8.protocol.SellStorageContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_8.protocol.SellStorageContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: TransactionExtention) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => TransactionExtention.deserialize(new Uint8Array(bytes))
            },
            ExchangeCreate: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_9.protocol.ExchangeCreateContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_9.protocol.ExchangeCreateContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: TransactionExtention) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => TransactionExtention.deserialize(new Uint8Array(bytes))
            },
            ExchangeInject: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_9.protocol.ExchangeInjectContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_9.protocol.ExchangeInjectContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: TransactionExtention) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => TransactionExtention.deserialize(new Uint8Array(bytes))
            },
            ExchangeWithdraw: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_9.protocol.ExchangeWithdrawContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_9.protocol.ExchangeWithdrawContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: TransactionExtention) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => TransactionExtention.deserialize(new Uint8Array(bytes))
            },
            ExchangeTransaction: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_9.protocol.ExchangeTransactionContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_9.protocol.ExchangeTransactionContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: TransactionExtention) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => TransactionExtention.deserialize(new Uint8Array(bytes))
            },
            MarketSellAsset: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_10.protocol.MarketSellAssetContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_10.protocol.MarketSellAssetContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: TransactionExtention) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => TransactionExtention.deserialize(new Uint8Array(bytes))
            },
            MarketCancelOrder: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_10.protocol.MarketCancelOrderContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_10.protocol.MarketCancelOrderContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: TransactionExtention) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => TransactionExtention.deserialize(new Uint8Array(bytes))
            },
            GetMarketOrderById: {
            ...
            DeployContract: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_11.protocol.CreateSmartContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_11.protocol.CreateSmartContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: TransactionExtention) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => TransactionExtention.deserialize(new Uint8Array(bytes))
            },
            GetContract: {
                ...
                requestSerialize: (message: BytesMessage) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => BytesMessage.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: dependency_11.protocol.SmartContract) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => dependency_11.protocol.SmartContract.deserialize(new Uint8Array(bytes))
            },
            GetContractInfo: {
                ...
                requestSerialize: (message: BytesMessage) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => BytesMessage.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: dependency_11.protocol.SmartContractDataWrapper) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => dependency_11.protocol.SmartContractDataWrapper.deserialize(new Uint8Array(bytes))
            },
            TriggerContract: {
                path: "/protocol.Wallet/TriggerContract",
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_11.protocol.TriggerSmartContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_11.protocol.TriggerSmartContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: TransactionExtention) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => TransactionExtention.deserialize(new Uint8Array(bytes))
            },
            ...
            ClearContractABI: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_11.protocol.ClearABIContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_11.protocol.ClearABIContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: TransactionExtention) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => TransactionExtention.deserialize(new Uint8Array(bytes))
            },
            ListWitnesses: {
            ...
            AccountPermissionUpdate: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_4.protocol.AccountPermissionUpdateContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_4.protocol.AccountPermissionUpdateContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: TransactionExtention) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => TransactionExtention.deserialize(new Uint8Array(bytes))
            },
            ...
            UpdateBrokerage: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_8.protocol.UpdateBrokerageContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_8.protocol.UpdateBrokerageContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: TransactionExtention) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => TransactionExtention.deserialize(new Uint8Array(bytes))
            },
            ...
            GetMerkleTreeVoucherInfo: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_12.protocol.OutputPointInfo) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_12.protocol.OutputPointInfo.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: dependency_12.protocol.IncrementalMerkleVoucherInfo) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => dependency_12.protocol.IncrementalMerkleVoucherInfo.deserialize(new Uint8Array(bytes))
            },
            ScanNoteByIvk: {
        ...
        abstract GetAccountBalance(call: grpc_1.ServerUnaryCall<dependency_6.protocol.AccountBalanceRequest, dependency_6.protocol.AccountBalanceResponse>, callback: grpc_1.sendUnaryData<dependency_6.protocol.AccountBalanceResponse>): void;
        abstract GetBlockBalanceTrace(call: grpc_1.ServerUnaryCall<dependency_6.protocol.BlockBalanceTrace.BlockIdentifier, dependency_6.protocol.BlockBalanceTrace>, callback: grpc_1.sendUnaryData<dependency_6.protocol.BlockBalanceTrace>): void;
        abstract CreateTransaction(call: grpc_1.ServerUnaryCall<dependency_6.protocol.TransferContract, dependency_1.protocol.Transaction>, callback: grpc_1.sendUnaryData<dependency_1.protocol.Transaction>): void;
        abstract CreateTransaction2(call: grpc_1.ServerUnaryCall<dependency_6.protocol.TransferContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        ...
        abstract UpdateAccount(call: grpc_1.ServerUnaryCall<dependency_4.protocol.AccountUpdateContract, dependency_1.protocol.Transaction>, callback: grpc_1.sendUnaryData<dependency_1.protocol.Transaction>): void;
        abstract SetAccountId(call: grpc_1.ServerUnaryCall<dependency_4.protocol.SetAccountIdContract, dependency_1.protocol.Transaction>, callback: grpc_1.sendUnaryData<dependency_1.protocol.Transaction>): void;
        abstract UpdateAccount2(call: grpc_1.ServerUnaryCall<dependency_4.protocol.AccountUpdateContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        abstract VoteWitnessAccount(call: grpc_1.ServerUnaryCall<dependency_5.protocol.VoteWitnessContract, dependency_1.protocol.Transaction>, callback: grpc_1.sendUnaryData<dependency_1.protocol.Transaction>): void;
        abstract UpdateSetting(call: grpc_1.ServerUnaryCall<dependency_11.protocol.UpdateSettingContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        abstract UpdateEnergyLimit(call: grpc_1.ServerUnaryCall<dependency_11.protocol.UpdateEnergyLimitContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        abstract VoteWitnessAccount2(call: grpc_1.ServerUnaryCall<dependency_5.protocol.VoteWitnessContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        abstract CreateAssetIssue(call: grpc_1.ServerUnaryCall<dependency_3.protocol.AssetIssueContract, dependency_1.protocol.Transaction>, callback: grpc_1.sendUnaryData<dependency_1.protocol.Transaction>): void;
        ...
        abstract UpdateWitness(call: grpc_1.ServerUnaryCall<dependency_5.protocol.WitnessUpdateContract, dependency_1.protocol.Transaction>, callback: grpc_1.sendUnaryData<dependency_1.protocol.Transaction>): void;
        abstract UpdateWitness2(call: grpc_1.ServerUnaryCall<dependency_5.protocol.WitnessUpdateContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        abstract CreateAccount(call: grpc_1.ServerUnaryCall<dependency_4.protocol.AccountCreateContract, dependency_1.protocol.Transaction>, callback: grpc_1.sendUnaryData<dependency_1.protocol.Transaction>): void;
        abstract CreateAccount2(call: grpc_1.ServerUnaryCall<dependency_4.protocol.AccountCreateContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        abstract CreateWitness(call: grpc_1.ServerUnaryCall<dependency_5.protocol.WitnessCreateContract, dependency_1.protocol.Transaction>, callback: grpc_1.sendUnaryData<dependency_1.protocol.Transaction>): void;
        abstract CreateWitness2(call: grpc_1.ServerUnaryCall<dependency_5.protocol.WitnessCreateContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        abstract TransferAsset(call: grpc_1.ServerUnaryCall<dependency_3.protocol.TransferAssetContract, dependency_1.protocol.Transaction>, callback: grpc_1.sendUnaryData<dependency_1.protocol.Transaction>): void;
        ...
        abstract ParticipateAssetIssue(call: grpc_1.ServerUnaryCall<dependency_3.protocol.ParticipateAssetIssueContract, dependency_1.protocol.Transaction>, callback: grpc_1.sendUnaryData<dependency_1.protocol.Transaction>): void;
        ...
        abstract FreezeBalance(call: grpc_1.ServerUnaryCall<dependency_6.protocol.FreezeBalanceContract, dependency_1.protocol.Transaction>, callback: grpc_1.sendUnaryData<dependency_1.protocol.Transaction>): void;
        abstract FreezeBalance2(call: grpc_1.ServerUnaryCall<dependency_6.protocol.FreezeBalanceContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        abstract FreezeBalanceV2(call: grpc_1.ServerUnaryCall<dependency_6.protocol.FreezeBalanceV2Contract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        abstract UnfreezeBalance(call: grpc_1.ServerUnaryCall<dependency_6.protocol.UnfreezeBalanceContract, dependency_1.protocol.Transaction>, callback: grpc_1.sendUnaryData<dependency_1.protocol.Transaction>): void;
        abstract UnfreezeBalance2(call: grpc_1.ServerUnaryCall<dependency_6.protocol.UnfreezeBalanceContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        abstract UnfreezeBalanceV2(call: grpc_1.ServerUnaryCall<dependency_6.protocol.UnfreezeBalanceV2Contract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        abstract UnfreezeAsset(call: grpc_1.ServerUnaryCall<dependency_3.protocol.UnfreezeAssetContract, dependency_1.protocol.Transaction>, callback: grpc_1.sendUnaryData<dependency_1.protocol.Transaction>): void;
        ...
        abstract WithdrawBalance(call: grpc_1.ServerUnaryCall<dependency_6.protocol.WithdrawBalanceContract, dependency_1.protocol.Transaction>, callback: grpc_1.sendUnaryData<dependency_1.protocol.Transaction>): void;
        abstract WithdrawBalance2(call: grpc_1.ServerUnaryCall<dependency_6.protocol.WithdrawBalanceContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        abstract WithdrawExpireUnfreeze(call: grpc_1.ServerUnaryCall<dependency_6.protocol.WithdrawExpireUnfreezeContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        abstract DelegateResource(call: grpc_1.ServerUnaryCall<dependency_6.protocol.DelegateResourceContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        abstract UnDelegateResource(call: grpc_1.ServerUnaryCall<dependency_6.protocol.UnDelegateResourceContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        abstract CancelAllUnfreezeV2(call: grpc_1.ServerUnaryCall<dependency_6.protocol.CancelAllUnfreezeV2Contract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        abstract UpdateAsset(call: grpc_1.ServerUnaryCall<dependency_3.protocol.UpdateAssetContract, dependency_1.protocol.Transaction>, callback: grpc_1.sendUnaryData<dependency_1.protocol.Transaction>): void;
        ...
        abstract ProposalCreate(call: grpc_1.ServerUnaryCall<dependency_7.protocol.ProposalCreateContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        abstract ProposalApprove(call: grpc_1.ServerUnaryCall<dependency_7.protocol.ProposalApproveContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        abstract ProposalDelete(call: grpc_1.ServerUnaryCall<dependency_7.protocol.ProposalDeleteContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        abstract BuyStorage(call: grpc_1.ServerUnaryCall<dependency_8.protocol.BuyStorageContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        abstract BuyStorageBytes(call: grpc_1.ServerUnaryCall<dependency_8.protocol.BuyStorageBytesContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        abstract SellStorage(call: grpc_1.ServerUnaryCall<dependency_8.protocol.SellStorageContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        abstract ExchangeCreate(call: grpc_1.ServerUnaryCall<dependency_9.protocol.ExchangeCreateContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        abstract ExchangeInject(call: grpc_1.ServerUnaryCall<dependency_9.protocol.ExchangeInjectContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        abstract ExchangeWithdraw(call: grpc_1.ServerUnaryCall<dependency_9.protocol.ExchangeWithdrawContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        abstract ExchangeTransaction(call: grpc_1.ServerUnaryCall<dependency_9.protocol.ExchangeTransactionContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        abstract MarketSellAsset(call: grpc_1.ServerUnaryCall<dependency_10.protocol.MarketSellAssetContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        abstract MarketCancelOrder(call: grpc_1.ServerUnaryCall<dependency_10.protocol.MarketCancelOrderContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        ...
        abstract DeployContract(call: grpc_1.ServerUnaryCall<dependency_11.protocol.CreateSmartContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        abstract GetContract(call: grpc_1.ServerUnaryCall<BytesMessage, dependency_11.protocol.SmartContract>, callback: grpc_1.sendUnaryData<dependency_11.protocol.SmartContract>): void;
        abstract GetContractInfo(call: grpc_1.ServerUnaryCall<BytesMessage, dependency_11.protocol.SmartContractDataWrapper>, callback: grpc_1.sendUnaryData<dependency_11.protocol.SmartContractDataWrapper>): void;
        abstract TriggerContract(call: grpc_1.ServerUnaryCall<dependency_11.protocol.TriggerSmartContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        abstract TriggerConstantContract(call: grpc_1.ServerUnaryCall<dependency_11.protocol.TriggerSmartContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        abstract EstimateEnergy(call: grpc_1.ServerUnaryCall<dependency_11.protocol.TriggerSmartContract, EstimateEnergyMessage>, callback: grpc_1.sendUnaryData<EstimateEnergyMessage>): void;
        abstract ClearContractABI(call: grpc_1.ServerUnaryCall<dependency_11.protocol.ClearABIContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        ...
        abstract AccountPermissionUpdate(call: grpc_1.ServerUnaryCall<dependency_4.protocol.AccountPermissionUpdateContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        ...
        abstract UpdateBrokerage(call: grpc_1.ServerUnaryCall<dependency_8.protocol.UpdateBrokerageContract, TransactionExtention>, callback: grpc_1.sendUnaryData<TransactionExtention>): void;
        ...
        abstract GetMerkleTreeVoucherInfo(call: grpc_1.ServerUnaryCall<dependency_12.protocol.OutputPointInfo, dependency_12.protocol.IncrementalMerkleVoucherInfo>, callback: grpc_1.sendUnaryData<dependency_12.protocol.IncrementalMerkleVoucherInfo>): void;
    ...
    export class WalletClient extends grpc_1.makeGenericClientConstructor(UnimplementedWalletService.definition, "Wallet", {}) {
        ...
        GetAccount: GrpcPromiseServiceInterface<dependency_1.protocol.Account, dependency_1.protocol.Account> = (message: dependency_1.protocol.Account, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.Account> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetAccount(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.Account) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetAccountById: GrpcPromiseServiceInterface<dependency_1.protocol.Account, dependency_1.protocol.Account> = (message: dependency_1.protocol.Account, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.Account> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetAccountById(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.Account) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetAccountBalance: GrpcPromiseServiceInterface<dependency_6.protocol.AccountBalanceRequest, dependency_6.protocol.AccountBalanceResponse> = (message: dependency_6.protocol.AccountBalanceRequest, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_6.protocol.AccountBalanceResponse> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetAccountBalance(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_6.protocol.AccountBalanceResponse) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetBlockBalanceTrace: GrpcPromiseServiceInterface<dependency_6.protocol.BlockBalanceTrace.BlockIdentifier, dependency_6.protocol.BlockBalanceTrace> = (message: dependency_6.protocol.BlockBalanceTrace.BlockIdentifier, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_6.protocol.BlockBalanceTrace> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetBlockBalanceTrace(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_6.protocol.BlockBalanceTrace) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        CreateTransaction: GrpcPromiseServiceInterface<dependency_6.protocol.TransferContract, dependency_1.protocol.Transaction> = (message: dependency_6.protocol.TransferContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.Transaction> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.CreateTransaction(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.Transaction) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        CreateTransaction2: GrpcPromiseServiceInterface<dependency_6.protocol.TransferContract, TransactionExtention> = (message: dependency_6.protocol.TransferContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.CreateTransaction2(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        BroadcastTransaction: GrpcPromiseServiceInterface<dependency_1.protocol.Transaction, Return> = (message: dependency_1.protocol.Transaction, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<Return> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.BroadcastTransaction(message, metadata, options, (error: grpc_1.ServiceError, response: Return) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        UpdateAccount: GrpcPromiseServiceInterface<dependency_4.protocol.AccountUpdateContract, dependency_1.protocol.Transaction> = (message: dependency_4.protocol.AccountUpdateContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.Transaction> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.UpdateAccount(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.Transaction) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        SetAccountId: GrpcPromiseServiceInterface<dependency_4.protocol.SetAccountIdContract, dependency_1.protocol.Transaction> = (message: dependency_4.protocol.SetAccountIdContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.Transaction> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.SetAccountId(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.Transaction) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        UpdateAccount2: GrpcPromiseServiceInterface<dependency_4.protocol.AccountUpdateContract, TransactionExtention> = (message: dependency_4.protocol.AccountUpdateContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.UpdateAccount2(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        VoteWitnessAccount: GrpcPromiseServiceInterface<dependency_5.protocol.VoteWitnessContract, dependency_1.protocol.Transaction> = (message: dependency_5.protocol.VoteWitnessContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.Transaction> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.VoteWitnessAccount(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.Transaction) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        UpdateSetting: GrpcPromiseServiceInterface<dependency_11.protocol.UpdateSettingContract, TransactionExtention> = (message: dependency_11.protocol.UpdateSettingContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.UpdateSetting(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        UpdateEnergyLimit: GrpcPromiseServiceInterface<dependency_11.protocol.UpdateEnergyLimitContract, TransactionExtention> = (message: dependency_11.protocol.UpdateEnergyLimitContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.UpdateEnergyLimit(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        VoteWitnessAccount2: GrpcPromiseServiceInterface<dependency_5.protocol.VoteWitnessContract, TransactionExtention> = (message: dependency_5.protocol.VoteWitnessContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.VoteWitnessAccount2(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        CreateAssetIssue: GrpcPromiseServiceInterface<dependency_3.protocol.AssetIssueContract, dependency_1.protocol.Transaction> = (message: dependency_3.protocol.AssetIssueContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.Transaction> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.CreateAssetIssue(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.Transaction) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        CreateAssetIssue2: GrpcPromiseServiceInterface<dependency_3.protocol.AssetIssueContract, TransactionExtention> = (message: dependency_3.protocol.AssetIssueContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.CreateAssetIssue2(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        UpdateWitness: GrpcPromiseServiceInterface<dependency_5.protocol.WitnessUpdateContract, dependency_1.protocol.Transaction> = (message: dependency_5.protocol.WitnessUpdateContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.Transaction> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.UpdateWitness(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.Transaction) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        UpdateWitness2: GrpcPromiseServiceInterface<dependency_5.protocol.WitnessUpdateContract, TransactionExtention> = (message: dependency_5.protocol.WitnessUpdateContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.UpdateWitness2(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        CreateAccount: GrpcPromiseServiceInterface<dependency_4.protocol.AccountCreateContract, dependency_1.protocol.Transaction> = (message: dependency_4.protocol.AccountCreateContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.Transaction> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.CreateAccount(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.Transaction) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        CreateAccount2: GrpcPromiseServiceInterface<dependency_4.protocol.AccountCreateContract, TransactionExtention> = (message: dependency_4.protocol.AccountCreateContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.CreateAccount2(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        CreateWitness: GrpcPromiseServiceInterface<dependency_5.protocol.WitnessCreateContract, dependency_1.protocol.Transaction> = (message: dependency_5.protocol.WitnessCreateContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.Transaction> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.CreateWitness(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.Transaction) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        CreateWitness2: GrpcPromiseServiceInterface<dependency_5.protocol.WitnessCreateContract, TransactionExtention> = (message: dependency_5.protocol.WitnessCreateContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.CreateWitness2(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        TransferAsset: GrpcPromiseServiceInterface<dependency_3.protocol.TransferAssetContract, dependency_1.protocol.Transaction> = (message: dependency_3.protocol.TransferAssetContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.Transaction> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.TransferAsset(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.Transaction) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        TransferAsset2: GrpcPromiseServiceInterface<dependency_3.protocol.TransferAssetContract, TransactionExtention> = (message: dependency_3.protocol.TransferAssetContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.TransferAsset2(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        ParticipateAssetIssue: GrpcPromiseServiceInterface<dependency_3.protocol.ParticipateAssetIssueContract, dependency_1.protocol.Transaction> = (message: dependency_3.protocol.ParticipateAssetIssueContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.Transaction> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.ParticipateAssetIssue(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.Transaction) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        ParticipateAssetIssue2: GrpcPromiseServiceInterface<dependency_3.protocol.ParticipateAssetIssueContract, TransactionExtention> = (message: dependency_3.protocol.ParticipateAssetIssueContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.ParticipateAssetIssue2(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        FreezeBalance: GrpcPromiseServiceInterface<dependency_6.protocol.FreezeBalanceContract, dependency_1.protocol.Transaction> = (message: dependency_6.protocol.FreezeBalanceContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.Transaction> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.FreezeBalance(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.Transaction) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        FreezeBalance2: GrpcPromiseServiceInterface<dependency_6.protocol.FreezeBalanceContract, TransactionExtention> = (message: dependency_6.protocol.FreezeBalanceContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.FreezeBalance2(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        FreezeBalanceV2: GrpcPromiseServiceInterface<dependency_6.protocol.FreezeBalanceV2Contract, TransactionExtention> = (message: dependency_6.protocol.FreezeBalanceV2Contract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.FreezeBalanceV2(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        UnfreezeBalance: GrpcPromiseServiceInterface<dependency_6.protocol.UnfreezeBalanceContract, dependency_1.protocol.Transaction> = (message: dependency_6.protocol.UnfreezeBalanceContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.Transaction> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.UnfreezeBalance(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.Transaction) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        UnfreezeBalance2: GrpcPromiseServiceInterface<dependency_6.protocol.UnfreezeBalanceContract, TransactionExtention> = (message: dependency_6.protocol.UnfreezeBalanceContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.UnfreezeBalance2(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        UnfreezeBalanceV2: GrpcPromiseServiceInterface<dependency_6.protocol.UnfreezeBalanceV2Contract, TransactionExtention> = (message: dependency_6.protocol.UnfreezeBalanceV2Contract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.UnfreezeBalanceV2(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        UnfreezeAsset: GrpcPromiseServiceInterface<dependency_3.protocol.UnfreezeAssetContract, dependency_1.protocol.Transaction> = (message: dependency_3.protocol.UnfreezeAssetContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.Transaction> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.UnfreezeAsset(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.Transaction) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        UnfreezeAsset2: GrpcPromiseServiceInterface<dependency_3.protocol.UnfreezeAssetContract, TransactionExtention> = (message: dependency_3.protocol.UnfreezeAssetContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.UnfreezeAsset2(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        WithdrawBalance: GrpcPromiseServiceInterface<dependency_6.protocol.WithdrawBalanceContract, dependency_1.protocol.Transaction> = (message: dependency_6.protocol.WithdrawBalanceContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.Transaction> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.WithdrawBalance(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.Transaction) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        WithdrawBalance2: GrpcPromiseServiceInterface<dependency_6.protocol.WithdrawBalanceContract, TransactionExtention> = (message: dependency_6.protocol.WithdrawBalanceContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.WithdrawBalance2(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        WithdrawExpireUnfreeze: GrpcPromiseServiceInterface<dependency_6.protocol.WithdrawExpireUnfreezeContract, TransactionExtention> = (message: dependency_6.protocol.WithdrawExpireUnfreezeContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.WithdrawExpireUnfreeze(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        DelegateResource: GrpcPromiseServiceInterface<dependency_6.protocol.DelegateResourceContract, TransactionExtention> = (message: dependency_6.protocol.DelegateResourceContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.DelegateResource(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        UnDelegateResource: GrpcPromiseServiceInterface<dependency_6.protocol.UnDelegateResourceContract, TransactionExtention> = (message: dependency_6.protocol.UnDelegateResourceContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.UnDelegateResource(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        CancelAllUnfreezeV2: GrpcPromiseServiceInterface<dependency_6.protocol.CancelAllUnfreezeV2Contract, TransactionExtention> = (message: dependency_6.protocol.CancelAllUnfreezeV2Contract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.CancelAllUnfreezeV2(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        UpdateAsset: GrpcPromiseServiceInterface<dependency_3.protocol.UpdateAssetContract, dependency_1.protocol.Transaction> = (message: dependency_3.protocol.UpdateAssetContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.Transaction> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.UpdateAsset(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.Transaction) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        UpdateAsset2: GrpcPromiseServiceInterface<dependency_3.protocol.UpdateAssetContract, TransactionExtention> = (message: dependency_3.protocol.UpdateAssetContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.UpdateAsset2(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        ProposalCreate: GrpcPromiseServiceInterface<dependency_7.protocol.ProposalCreateContract, TransactionExtention> = (message: dependency_7.protocol.ProposalCreateContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.ProposalCreate(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        ProposalApprove: GrpcPromiseServiceInterface<dependency_7.protocol.ProposalApproveContract, TransactionExtention> = (message: dependency_7.protocol.ProposalApproveContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.ProposalApprove(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        ProposalDelete: GrpcPromiseServiceInterface<dependency_7.protocol.ProposalDeleteContract, TransactionExtention> = (message: dependency_7.protocol.ProposalDeleteContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.ProposalDelete(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        BuyStorage: GrpcPromiseServiceInterface<dependency_8.protocol.BuyStorageContract, TransactionExtention> = (message: dependency_8.protocol.BuyStorageContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.BuyStorage(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        BuyStorageBytes: GrpcPromiseServiceInterface<dependency_8.protocol.BuyStorageBytesContract, TransactionExtention> = (message: dependency_8.protocol.BuyStorageBytesContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.BuyStorageBytes(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        SellStorage: GrpcPromiseServiceInterface<dependency_8.protocol.SellStorageContract, TransactionExtention> = (message: dependency_8.protocol.SellStorageContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.SellStorage(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        ExchangeCreate: GrpcPromiseServiceInterface<dependency_9.protocol.ExchangeCreateContract, TransactionExtention> = (message: dependency_9.protocol.ExchangeCreateContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.ExchangeCreate(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        ExchangeInject: GrpcPromiseServiceInterface<dependency_9.protocol.ExchangeInjectContract, TransactionExtention> = (message: dependency_9.protocol.ExchangeInjectContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.ExchangeInject(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        ExchangeWithdraw: GrpcPromiseServiceInterface<dependency_9.protocol.ExchangeWithdrawContract, TransactionExtention> = (message: dependency_9.protocol.ExchangeWithdrawContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.ExchangeWithdraw(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        ExchangeTransaction: GrpcPromiseServiceInterface<dependency_9.protocol.ExchangeTransactionContract, TransactionExtention> = (message: dependency_9.protocol.ExchangeTransactionContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.ExchangeTransaction(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        MarketSellAsset: GrpcPromiseServiceInterface<dependency_10.protocol.MarketSellAssetContract, TransactionExtention> = (message: dependency_10.protocol.MarketSellAssetContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.MarketSellAsset(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        MarketCancelOrder: GrpcPromiseServiceInterface<dependency_10.protocol.MarketCancelOrderContract, TransactionExtention> = (message: dependency_10.protocol.MarketCancelOrderContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.MarketCancelOrder(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetMarketOrderById: GrpcPromiseServiceInterface<BytesMessage, dependency_1.protocol.MarketOrder> = (message: BytesMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.MarketOrder> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetMarketOrderById(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.MarketOrder) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetMarketOrderByAccount: GrpcPromiseServiceInterface<BytesMessage, dependency_1.protocol.MarketOrderList> = (message: BytesMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.MarketOrderList> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetMarketOrderByAccount(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.MarketOrderList) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetMarketPriceByPair: GrpcPromiseServiceInterface<dependency_1.protocol.MarketOrderPair, dependency_1.protocol.MarketPriceList> = (message: dependency_1.protocol.MarketOrderPair, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.MarketPriceList> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetMarketPriceByPair(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.MarketPriceList) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetMarketOrderListByPair: GrpcPromiseServiceInterface<dependency_1.protocol.MarketOrderPair, dependency_1.protocol.MarketOrderList> = (message: dependency_1.protocol.MarketOrderPair, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.MarketOrderList> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetMarketOrderListByPair(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.MarketOrderList) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetMarketPairList: GrpcPromiseServiceInterface<EmptyMessage, dependency_1.protocol.MarketOrderPairList> = (message: EmptyMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.MarketOrderPairList> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetMarketPairList(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.MarketOrderPairList) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        ListNodes: GrpcPromiseServiceInterface<EmptyMessage, NodeList> = (message: EmptyMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<NodeList> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.ListNodes(message, metadata, options, (error: grpc_1.ServiceError, response: NodeList) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetAssetIssueByAccount: GrpcPromiseServiceInterface<dependency_1.protocol.Account, AssetIssueList> = (message: dependency_1.protocol.Account, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<AssetIssueList> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetAssetIssueByAccount(message, metadata, options, (error: grpc_1.ServiceError, response: AssetIssueList) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetAccountNet: GrpcPromiseServiceInterface<dependency_1.protocol.Account, AccountNetMessage> = (message: dependency_1.protocol.Account, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<AccountNetMessage> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetAccountNet(message, metadata, options, (error: grpc_1.ServiceError, response: AccountNetMessage) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetAccountResource: GrpcPromiseServiceInterface<dependency_1.protocol.Account, AccountResourceMessage> = (message: dependency_1.protocol.Account, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<AccountResourceMessage> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetAccountResource(message, metadata, options, (error: grpc_1.ServiceError, response: AccountResourceMessage) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetAssetIssueByName: GrpcPromiseServiceInterface<BytesMessage, dependency_3.protocol.AssetIssueContract> = (message: BytesMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_3.protocol.AssetIssueContract> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetAssetIssueByName(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_3.protocol.AssetIssueContract) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetAssetIssueListByName: GrpcPromiseServiceInterface<BytesMessage, AssetIssueList> = (message: BytesMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<AssetIssueList> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetAssetIssueListByName(message, metadata, options, (error: grpc_1.ServiceError, response: AssetIssueList) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetAssetIssueById: GrpcPromiseServiceInterface<BytesMessage, dependency_3.protocol.AssetIssueContract> = (message: BytesMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_3.protocol.AssetIssueContract> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetAssetIssueById(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_3.protocol.AssetIssueContract) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetNowBlock: GrpcPromiseServiceInterface<EmptyMessage, dependency_1.protocol.Block> = (message: EmptyMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.Block> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetNowBlock(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.Block) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetNowBlock2: GrpcPromiseServiceInterface<EmptyMessage, BlockExtention> = (message: EmptyMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<BlockExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetNowBlock2(message, metadata, options, (error: grpc_1.ServiceError, response: BlockExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetBlockByNum: GrpcPromiseServiceInterface<NumberMessage, dependency_1.protocol.Block> = (message: NumberMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.Block> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetBlockByNum(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.Block) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetBlockByNum2: GrpcPromiseServiceInterface<NumberMessage, BlockExtention> = (message: NumberMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<BlockExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetBlockByNum2(message, metadata, options, (error: grpc_1.ServiceError, response: BlockExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetTransactionCountByBlockNum: GrpcPromiseServiceInterface<NumberMessage, NumberMessage> = (message: NumberMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<NumberMessage> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetTransactionCountByBlockNum(message, metadata, options, (error: grpc_1.ServiceError, response: NumberMessage) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetBlockById: GrpcPromiseServiceInterface<BytesMessage, dependency_1.protocol.Block> = (message: BytesMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.Block> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetBlockById(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.Block) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetBlockByLimitNext: GrpcPromiseServiceInterface<BlockLimit, BlockList> = (message: BlockLimit, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<BlockList> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetBlockByLimitNext(message, metadata, options, (error: grpc_1.ServiceError, response: BlockList) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetBlockByLimitNext2: GrpcPromiseServiceInterface<BlockLimit, BlockListExtention> = (message: BlockLimit, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<BlockListExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetBlockByLimitNext2(message, metadata, options, (error: grpc_1.ServiceError, response: BlockListExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetBlockByLatestNum: GrpcPromiseServiceInterface<NumberMessage, BlockList> = (message: NumberMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<BlockList> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetBlockByLatestNum(message, metadata, options, (error: grpc_1.ServiceError, response: BlockList) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetBlockByLatestNum2: GrpcPromiseServiceInterface<NumberMessage, BlockListExtention> = (message: NumberMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<BlockListExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetBlockByLatestNum2(message, metadata, options, (error: grpc_1.ServiceError, response: BlockListExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetTransactionById: GrpcPromiseServiceInterface<BytesMessage, dependency_1.protocol.Transaction> = (message: BytesMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.Transaction> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetTransactionById(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.Transaction) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        DeployContract: GrpcPromiseServiceInterface<dependency_11.protocol.CreateSmartContract, TransactionExtention> = (message: dependency_11.protocol.CreateSmartContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.DeployContract(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetContract: GrpcPromiseServiceInterface<BytesMessage, dependency_11.protocol.SmartContract> = (message: BytesMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_11.protocol.SmartContract> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetContract(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_11.protocol.SmartContract) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetContractInfo: GrpcPromiseServiceInterface<BytesMessage, dependency_11.protocol.SmartContractDataWrapper> = (message: BytesMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_11.protocol.SmartContractDataWrapper> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetContractInfo(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_11.protocol.SmartContractDataWrapper) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        TriggerContract: GrpcPromiseServiceInterface<dependency_11.protocol.TriggerSmartContract, TransactionExtention> = (message: dependency_11.protocol.TriggerSmartContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.TriggerContract(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        TriggerConstantContract: GrpcPromiseServiceInterface<dependency_11.protocol.TriggerSmartContract, TransactionExtention> = (message: dependency_11.protocol.TriggerSmartContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.TriggerConstantContract(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        EstimateEnergy: GrpcPromiseServiceInterface<dependency_11.protocol.TriggerSmartContract, EstimateEnergyMessage> = (message: dependency_11.protocol.TriggerSmartContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<EstimateEnergyMessage> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.EstimateEnergy(message, metadata, options, (error: grpc_1.ServiceError, response: EstimateEnergyMessage) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        ClearContractABI: GrpcPromiseServiceInterface<dependency_11.protocol.ClearABIContract, TransactionExtention> = (message: dependency_11.protocol.ClearABIContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.ClearContractABI(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        ListWitnesses: GrpcPromiseServiceInterface<EmptyMessage, WitnessList> = (message: EmptyMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<WitnessList> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.ListWitnesses(message, metadata, options, (error: grpc_1.ServiceError, response: WitnessList) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetDelegatedResource: GrpcPromiseServiceInterface<DelegatedResourceMessage, DelegatedResourceList> = (message: DelegatedResourceMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<DelegatedResourceList> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetDelegatedResource(message, metadata, options, (error: grpc_1.ServiceError, response: DelegatedResourceList) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetDelegatedResourceV2: GrpcPromiseServiceInterface<DelegatedResourceMessage, DelegatedResourceList> = (message: DelegatedResourceMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<DelegatedResourceList> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetDelegatedResourceV2(message, metadata, options, (error: grpc_1.ServiceError, response: DelegatedResourceList) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetDelegatedResourceAccountIndex: GrpcPromiseServiceInterface<BytesMessage, dependency_1.protocol.DelegatedResourceAccountIndex> = (message: BytesMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.DelegatedResourceAccountIndex> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetDelegatedResourceAccountIndex(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.DelegatedResourceAccountIndex) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetDelegatedResourceAccountIndexV2: GrpcPromiseServiceInterface<BytesMessage, dependency_1.protocol.DelegatedResourceAccountIndex> = (message: BytesMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.DelegatedResourceAccountIndex> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetDelegatedResourceAccountIndexV2(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.DelegatedResourceAccountIndex) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetCanDelegatedMaxSize: GrpcPromiseServiceInterface<CanDelegatedMaxSizeRequestMessage, CanDelegatedMaxSizeResponseMessage> = (message: CanDelegatedMaxSizeRequestMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<CanDelegatedMaxSizeResponseMessage> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetCanDelegatedMaxSize(message, metadata, options, (error: grpc_1.ServiceError, response: CanDelegatedMaxSizeResponseMessage) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetAvailableUnfreezeCount: GrpcPromiseServiceInterface<GetAvailableUnfreezeCountRequestMessage, GetAvailableUnfreezeCountResponseMessage> = (message: GetAvailableUnfreezeCountRequestMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<GetAvailableUnfreezeCountResponseMessage> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetAvailableUnfreezeCount(message, metadata, options, (error: grpc_1.ServiceError, response: GetAvailableUnfreezeCountResponseMessage) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetCanWithdrawUnfreezeAmount: GrpcPromiseServiceInterface<CanWithdrawUnfreezeAmountRequestMessage, CanWithdrawUnfreezeAmountResponseMessage> = (message: CanWithdrawUnfreezeAmountRequestMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<CanWithdrawUnfreezeAmountResponseMessage> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetCanWithdrawUnfreezeAmount(message, metadata, options, (error: grpc_1.ServiceError, response: CanWithdrawUnfreezeAmountResponseMessage) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        ListProposals: GrpcPromiseServiceInterface<EmptyMessage, ProposalList> = (message: EmptyMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<ProposalList> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.ListProposals(message, metadata, options, (error: grpc_1.ServiceError, response: ProposalList) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetPaginatedProposalList: GrpcPromiseServiceInterface<PaginatedMessage, ProposalList> = (message: PaginatedMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<ProposalList> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetPaginatedProposalList(message, metadata, options, (error: grpc_1.ServiceError, response: ProposalList) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetProposalById: GrpcPromiseServiceInterface<BytesMessage, dependency_1.protocol.Proposal> = (message: BytesMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.Proposal> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetProposalById(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.Proposal) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        ListExchanges: GrpcPromiseServiceInterface<EmptyMessage, ExchangeList> = (message: EmptyMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<ExchangeList> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.ListExchanges(message, metadata, options, (error: grpc_1.ServiceError, response: ExchangeList) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetPaginatedExchangeList: GrpcPromiseServiceInterface<PaginatedMessage, ExchangeList> = (message: PaginatedMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<ExchangeList> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetPaginatedExchangeList(message, metadata, options, (error: grpc_1.ServiceError, response: ExchangeList) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetExchangeById: GrpcPromiseServiceInterface<BytesMessage, dependency_1.protocol.Exchange> = (message: BytesMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.Exchange> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetExchangeById(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.Exchange) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetChainParameters: GrpcPromiseServiceInterface<EmptyMessage, dependency_1.protocol.ChainParameters> = (message: EmptyMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.ChainParameters> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetChainParameters(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.ChainParameters) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetAssetIssueList: GrpcPromiseServiceInterface<EmptyMessage, AssetIssueList> = (message: EmptyMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<AssetIssueList> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetAssetIssueList(message, metadata, options, (error: grpc_1.ServiceError, response: AssetIssueList) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetPaginatedAssetIssueList: GrpcPromiseServiceInterface<PaginatedMessage, AssetIssueList> = (message: PaginatedMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<AssetIssueList> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetPaginatedAssetIssueList(message, metadata, options, (error: grpc_1.ServiceError, response: AssetIssueList) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        TotalTransaction: GrpcPromiseServiceInterface<EmptyMessage, NumberMessage> = (message: EmptyMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<NumberMessage> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.TotalTransaction(message, metadata, options, (error: grpc_1.ServiceError, response: NumberMessage) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetNextMaintenanceTime: GrpcPromiseServiceInterface<EmptyMessage, NumberMessage> = (message: EmptyMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<NumberMessage> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetNextMaintenanceTime(message, metadata, options, (error: grpc_1.ServiceError, response: NumberMessage) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetTransactionInfoById: GrpcPromiseServiceInterface<BytesMessage, dependency_1.protocol.TransactionInfo> = (message: BytesMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.TransactionInfo> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetTransactionInfoById(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.TransactionInfo) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        AccountPermissionUpdate: GrpcPromiseServiceInterface<dependency_4.protocol.AccountPermissionUpdateContract, TransactionExtention> = (message: dependency_4.protocol.AccountPermissionUpdateContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.AccountPermissionUpdate(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetTransactionSignWeight: GrpcPromiseServiceInterface<dependency_1.protocol.Transaction, TransactionSignWeight> = (message: dependency_1.protocol.Transaction, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionSignWeight> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetTransactionSignWeight(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionSignWeight) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetTransactionApprovedList: GrpcPromiseServiceInterface<dependency_1.protocol.Transaction, TransactionApprovedList> = (message: dependency_1.protocol.Transaction, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionApprovedList> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetTransactionApprovedList(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionApprovedList) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetNodeInfo: GrpcPromiseServiceInterface<EmptyMessage, dependency_1.protocol.NodeInfo> = (message: EmptyMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.NodeInfo> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetNodeInfo(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.NodeInfo) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetRewardInfo: GrpcPromiseServiceInterface<BytesMessage, NumberMessage> = (message: BytesMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<NumberMessage> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetRewardInfo(message, metadata, options, (error: grpc_1.ServiceError, response: NumberMessage) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetBrokerageInfo: GrpcPromiseServiceInterface<BytesMessage, NumberMessage> = (message: BytesMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<NumberMessage> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetBrokerageInfo(message, metadata, options, (error: grpc_1.ServiceError, response: NumberMessage) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        UpdateBrokerage: GrpcPromiseServiceInterface<dependency_8.protocol.UpdateBrokerageContract, TransactionExtention> = (message: dependency_8.protocol.UpdateBrokerageContract, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.UpdateBrokerage(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        CreateShieldedTransaction: GrpcPromiseServiceInterface<PrivateParameters, TransactionExtention> = (message: PrivateParameters, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.CreateShieldedTransaction(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetMerkleTreeVoucherInfo: GrpcPromiseServiceInterface<dependency_12.protocol.OutputPointInfo, dependency_12.protocol.IncrementalMerkleVoucherInfo> = (message: dependency_12.protocol.OutputPointInfo, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_12.protocol.IncrementalMerkleVoucherInfo> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetMerkleTreeVoucherInfo(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_12.protocol.IncrementalMerkleVoucherInfo) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        ScanNoteByIvk: GrpcPromiseServiceInterface<IvkDecryptParameters, DecryptNotes> = (message: IvkDecryptParameters, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<DecryptNotes> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.ScanNoteByIvk(message, metadata, options, (error: grpc_1.ServiceError, response: DecryptNotes) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        ScanAndMarkNoteByIvk: GrpcPromiseServiceInterface<IvkDecryptAndMarkParameters, DecryptNotesMarked> = (message: IvkDecryptAndMarkParameters, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<DecryptNotesMarked> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.ScanAndMarkNoteByIvk(message, metadata, options, (error: grpc_1.ServiceError, response: DecryptNotesMarked) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        ScanNoteByOvk: GrpcPromiseServiceInterface<OvkDecryptParameters, DecryptNotes> = (message: OvkDecryptParameters, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<DecryptNotes> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.ScanNoteByOvk(message, metadata, options, (error: grpc_1.ServiceError, response: DecryptNotes) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetSpendingKey: GrpcPromiseServiceInterface<EmptyMessage, BytesMessage> = (message: EmptyMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<BytesMessage> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetSpendingKey(message, metadata, options, (error: grpc_1.ServiceError, response: BytesMessage) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetExpandedSpendingKey: GrpcPromiseServiceInterface<BytesMessage, ExpandedSpendingKeyMessage> = (message: BytesMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<ExpandedSpendingKeyMessage> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetExpandedSpendingKey(message, metadata, options, (error: grpc_1.ServiceError, response: ExpandedSpendingKeyMessage) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetAkFromAsk: GrpcPromiseServiceInterface<BytesMessage, BytesMessage> = (message: BytesMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<BytesMessage> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetAkFromAsk(message, metadata, options, (error: grpc_1.ServiceError, response: BytesMessage) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetNkFromNsk: GrpcPromiseServiceInterface<BytesMessage, BytesMessage> = (message: BytesMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<BytesMessage> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetNkFromNsk(message, metadata, options, (error: grpc_1.ServiceError, response: BytesMessage) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetIncomingViewingKey: GrpcPromiseServiceInterface<ViewingKeyMessage, IncomingViewingKeyMessage> = (message: ViewingKeyMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<IncomingViewingKeyMessage> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetIncomingViewingKey(message, metadata, options, (error: grpc_1.ServiceError, response: IncomingViewingKeyMessage) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetDiversifier: GrpcPromiseServiceInterface<EmptyMessage, DiversifierMessage> = (message: EmptyMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<DiversifierMessage> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetDiversifier(message, metadata, options, (error: grpc_1.ServiceError, response: DiversifierMessage) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetNewShieldedAddress: GrpcPromiseServiceInterface<EmptyMessage, ShieldedAddressInfo> = (message: EmptyMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<ShieldedAddressInfo> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetNewShieldedAddress(message, metadata, options, (error: grpc_1.ServiceError, response: ShieldedAddressInfo) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetZenPaymentAddress: GrpcPromiseServiceInterface<IncomingViewingKeyDiversifierMessage, PaymentAddressMessage> = (message: IncomingViewingKeyDiversifierMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<PaymentAddressMessage> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetZenPaymentAddress(message, metadata, options, (error: grpc_1.ServiceError, response: PaymentAddressMessage) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetRcm: GrpcPromiseServiceInterface<EmptyMessage, BytesMessage> = (message: EmptyMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<BytesMessage> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetRcm(message, metadata, options, (error: grpc_1.ServiceError, response: BytesMessage) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        IsSpend: GrpcPromiseServiceInterface<NoteParameters, SpendResult> = (message: NoteParameters, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<SpendResult> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.IsSpend(message, metadata, options, (error: grpc_1.ServiceError, response: SpendResult) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        CreateShieldedTransactionWithoutSpendAuthSig: GrpcPromiseServiceInterface<PrivateParametersWithoutAsk, TransactionExtention> = (message: PrivateParametersWithoutAsk, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.CreateShieldedTransactionWithoutSpendAuthSig(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetShieldTransactionHash: GrpcPromiseServiceInterface<dependency_1.protocol.Transaction, BytesMessage> = (message: dependency_1.protocol.Transaction, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<BytesMessage> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetShieldTransactionHash(message, metadata, options, (error: grpc_1.ServiceError, response: BytesMessage) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        CreateSpendAuthSig: GrpcPromiseServiceInterface<SpendAuthSigParameters, BytesMessage> = (message: SpendAuthSigParameters, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<BytesMessage> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.CreateSpendAuthSig(message, metadata, options, (error: grpc_1.ServiceError, response: BytesMessage) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        CreateShieldNullifier: GrpcPromiseServiceInterface<NfParameters, BytesMessage> = (message: NfParameters, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<BytesMessage> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.CreateShieldNullifier(message, metadata, options, (error: grpc_1.ServiceError, response: BytesMessage) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        CreateShieldedContractParameters: GrpcPromiseServiceInterface<PrivateShieldedTRC20Parameters, ShieldedTRC20Parameters> = (message: PrivateShieldedTRC20Parameters, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<ShieldedTRC20Parameters> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.CreateShieldedContractParameters(message, metadata, options, (error: grpc_1.ServiceError, response: ShieldedTRC20Parameters) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        CreateShieldedContractParametersWithoutAsk: GrpcPromiseServiceInterface<PrivateShieldedTRC20ParametersWithoutAsk, ShieldedTRC20Parameters> = (message: PrivateShieldedTRC20ParametersWithoutAsk, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<ShieldedTRC20Parameters> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.CreateShieldedContractParametersWithoutAsk(message, metadata, options, (error: grpc_1.ServiceError, response: ShieldedTRC20Parameters) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        ScanShieldedTRC20NotesByIvk: GrpcPromiseServiceInterface<IvkDecryptTRC20Parameters, DecryptNotesTRC20> = (message: IvkDecryptTRC20Parameters, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<DecryptNotesTRC20> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.ScanShieldedTRC20NotesByIvk(message, metadata, options, (error: grpc_1.ServiceError, response: DecryptNotesTRC20) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        ScanShieldedTRC20NotesByOvk: GrpcPromiseServiceInterface<OvkDecryptTRC20Parameters, DecryptNotesTRC20> = (message: OvkDecryptTRC20Parameters, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<DecryptNotesTRC20> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.ScanShieldedTRC20NotesByOvk(message, metadata, options, (error: grpc_1.ServiceError, response: DecryptNotesTRC20) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        IsShieldedTRC20ContractNoteSpent: GrpcPromiseServiceInterface<NfTRC20Parameters, NullifierResult> = (message: NfTRC20Parameters, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<NullifierResult> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.IsShieldedTRC20ContractNoteSpent(message, metadata, options, (error: grpc_1.ServiceError, response: NullifierResult) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetTriggerInputForShieldedTRC20Contract: GrpcPromiseServiceInterface<ShieldedTRC20TriggerContractParameters, BytesMessage> = (message: ShieldedTRC20TriggerContractParameters, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<BytesMessage> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetTriggerInputForShieldedTRC20Contract(message, metadata, options, (error: grpc_1.ServiceError, response: BytesMessage) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        CreateCommonTransaction: GrpcPromiseServiceInterface<dependency_1.protocol.Transaction, TransactionExtention> = (message: dependency_1.protocol.Transaction, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.CreateCommonTransaction(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetTransactionInfoByBlockNum: GrpcPromiseServiceInterface<NumberMessage, TransactionInfoList> = (message: NumberMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionInfoList> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetTransactionInfoByBlockNum(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionInfoList) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetBurnTrx: GrpcPromiseServiceInterface<EmptyMessage, NumberMessage> = (message: EmptyMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<NumberMessage> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetBurnTrx(message, metadata, options, (error: grpc_1.ServiceError, response: NumberMessage) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetTransactionFromPending: GrpcPromiseServiceInterface<BytesMessage, dependency_1.protocol.Transaction> = (message: BytesMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.Transaction> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetTransactionFromPending(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.Transaction) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetTransactionListFromPending: GrpcPromiseServiceInterface<EmptyMessage, TransactionIdList> = (message: EmptyMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionIdList> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetTransactionListFromPending(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionIdList) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetPendingSize: GrpcPromiseServiceInterface<EmptyMessage, NumberMessage> = (message: EmptyMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<NumberMessage> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetPendingSize(message, metadata, options, (error: grpc_1.ServiceError, response: NumberMessage) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetBlock: GrpcPromiseServiceInterface<BlockReq, BlockExtention> = (message: BlockReq, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<BlockExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetBlock(message, metadata, options, (error: grpc_1.ServiceError, response: BlockExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetBandwidthPrices: GrpcPromiseServiceInterface<EmptyMessage, PricesResponseMessage> = (message: EmptyMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<PricesResponseMessage> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetBandwidthPrices(message, metadata, options, (error: grpc_1.ServiceError, response: PricesResponseMessage) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetEnergyPrices: GrpcPromiseServiceInterface<EmptyMessage, PricesResponseMessage> = (message: EmptyMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<PricesResponseMessage> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetEnergyPrices(message, metadata, options, (error: grpc_1.ServiceError, response: PricesResponseMessage) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetMemoFee: GrpcPromiseServiceInterface<EmptyMessage, PricesResponseMessage> = (message: EmptyMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<PricesResponseMessage> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetMemoFee(message, metadata, options, (error: grpc_1.ServiceError, response: PricesResponseMessage) => {
            if (error) {
                reject(error);
            }
            else {
    ...
    export class WalletExtensionClient extends grpc_1.makeGenericClientConstructor(UnimplementedWalletExtensionService.definition, "WalletExtension", {}) {
        ...
        GetTransactionsFromThis: GrpcPromiseServiceInterface<AccountPaginated, TransactionList> = (message: AccountPaginated, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionList> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetTransactionsFromThis(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionList) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetTransactionsFromThis2: GrpcPromiseServiceInterface<AccountPaginated, TransactionListExtention> = (message: AccountPaginated, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionListExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetTransactionsFromThis2(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionListExtention) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetTransactionsToThis: GrpcPromiseServiceInterface<AccountPaginated, TransactionList> = (message: AccountPaginated, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionList> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetTransactionsToThis(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionList) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetTransactionsToThis2: GrpcPromiseServiceInterface<AccountPaginated, TransactionListExtention> = (message: AccountPaginated, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<TransactionListExtention> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetTransactionsToThis2(message, metadata, options, (error: grpc_1.ServiceError, response: TransactionListExtention) => {
            if (error) {
                reject(error);
            }
            else {
    ...
    export class DatabaseClient extends grpc_1.makeGenericClientConstructor(UnimplementedDatabaseService.definition, "Database", {}) {
        ...
        getBlockReference: GrpcPromiseServiceInterface<EmptyMessage, BlockReference> = (message: EmptyMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<BlockReference> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.getBlockReference(message, metadata, options, (error: grpc_1.ServiceError, response: BlockReference) => {
            if (error) {
                reject(error);
            }
            else {
        ...
        GetDynamicProperties: GrpcPromiseServiceInterface<EmptyMessage, dependency_1.protocol.DynamicProperties> = (message: EmptyMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.DynamicProperties> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetDynamicProperties(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.DynamicProperties) => {
            if (error) {
                reject(error);
            }
            else {
    ...
    export class MonitorClient extends grpc_1.makeGenericClientConstructor(UnimplementedMonitorService.definition, "Monitor", {}) {
        ...
        GetStatsInfo: GrpcPromiseServiceInterface<EmptyMessage, dependency_1.protocol.MetricsInfo> = (message: EmptyMessage, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): Promise<dependency_1.protocol.MetricsInfo> => { if (!metadata) {
            metadata = new grpc_1.Metadata;
        } if (!options) {
            options = {};
        } return new Promise((resolve, reject) => super.GetStatsInfo(message, metadata, options, (error: grpc_1.ServiceError, response: dependency_1.protocol.MetricsInfo) => {
            if (error) {
                reject(error);
            }
            else {
